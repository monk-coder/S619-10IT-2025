class Country {
    ...
    render() {
        ...
        return `<div class="country-card">
            ...
            <div class="country-info">
                <h2 class="country-name"><i class="fas fa-flag"></i> ${this.data.name}<small>(${this.data.nativeName})</small></h2>
                <div class="country-detail"><i class="fas fa-landmark"></i><strong>Столица:</strong> ${this.data.capital}</div>
                <div class="country-detail"><i class="fas fa-globe-europe"></i><strong>Регион:</strong> ${this.data.region}</div>
                <div class="country-detail"><i class="fas fa-users"></i><strong>Население:</strong> ${this.data.population}</div>
                <div class="country-detail"><i class="fas fa-ruler-combined"></i><strong>Площадь:</strong> ${this.data.area}</div>
                <div class="country-detail"><i class="fas fa-language"></i><strong>Языки:</strong> ${this.data.languages}</div>
                <div class="country-detail"><i class="fas fa-money-bill-wave"></i><strong>Валюта:</strong> ${this.data.currency}</div>
                <div class="country-description"><p><strong>Описание:</strong> ${this.data.description}</p></div>
                ...
                <button class="add-to-wishlist" onclick="Wishlist.add(${safeData})"><i class="fas fa-heart"></i> Добавить в вишлист</button>
            </div>
        </div>`;
    }
    ...
    static async getAIGuide(countryName) {
        ...
        try {
            ...
            guideElement.innerHTML = `<div class="ai-guide-card">
            ...
            guideElement.innerHTML = `<div class="error-message">
