...
# Weather API Key
WEATHER_API_KEY = os.getenv('WEATHER_API_KEY', 'de0ba8afcd2606f2eccf6c212abe0906')

# Проверка только для продакшена
if not DEBUG:
    if not WEATHER_API_KEY:
        raise Exception('WEATHER_API_KEY must be set in production')
    if SECRET_KEY == 'django-insecure-development-key-only':
